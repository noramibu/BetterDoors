...
import me.noramibu.platform.FabricPermissionChecker;
...
public final class BetterDoorsFabric implements ModInitializer {
    @Override
    public void onInitialize() {
        BetterDoorsCommon.init(FabricLoader.getInstance().getConfigDir(), new FabricPermissionChecker());
